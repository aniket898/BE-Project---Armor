...
public class permissiont extends HttpServlet
{
            ...
            throws ServletException, IOException, Exception 
    {
        ...
        PrintWriter out = response.getWriter();
            PermissionDiag obj=new PermissionDiag();
        obj.funcmain();
             ...
             "   <script src='j_scripts/jquery-1.9.1.js'></script>   "+
              "  <script src='j_scripts/jquery-ui.js'></script> "+
               ...
               "</div>"+
                ...
                toprint1=toprint1+obj.chart1 +
                "</div>"+
                "<h3>Section 2</h3>"+
                "<div id='graph_container' style='border:1px solid #555555 ;overflow : hidden ; height: 500px'>"+
                "<div id='chart_div' style='height:400px;overflow:auto;padding-top : 3%;padding-left:3%;float:left;width:100%;'>"+
                obj.table1+
                 "</div>"+
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(permissiont.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
